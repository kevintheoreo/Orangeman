...
4. Periodically (every few seconds), the blob either:
   ...
   - Pauses to perform a brief random idle action (jump, spin, wave, squash-stretch pulse, or a brief color tint flash), then resumes walking.
